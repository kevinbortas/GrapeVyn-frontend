...
// import { getOwnedTokens, getOwnerByIndex } from './Web3Client';
import "./css/AccountBox.css";
import { connect } from 'react-redux';
import Post from './PostComponent';
import { LoadingContentCircle } from "./LoadingComponent";
import { getOwnedTokens } from "./APIHandler";
...
class AccountBlocks extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        // if (prevState.ownedAddress !== this.props.state.address){
        //     this.setState({ownedAddress: this.props.state.address});
        //     this.getTokens();
        // }
    }
