...
import { init, ifWalletConnected, reverseLookUp } from './Web3Client';
...
class UserBox extends React.Component {
    ...
    componentDidMount() {
        ...
        // this.setState({ isConnected: this.props.state.isConnected, walletAddress: this.props.state.address });
        // ifWalletConnected();
    }
